...
/**
 * merge - merges the copied array into the original
 * @array: array of integers to sort
 * @copy: copy of the array to sort
 * @left: left-most index beginning of array;
 * @right: right-most index  array end;
 * @mid: point between left and right indexes
 */
